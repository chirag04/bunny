...
public interface JDBIIntermediaryFilesRepository extends IntermediaryFilesRepository {
  ...
  @Override
  @SqlQuery("select * from intermediary_files where root_id=:root_id and filename=:filename")
  IntermediaryFileEntity get(@Bind("root_id") UUID root_id, @Bind("filename") String filename);
